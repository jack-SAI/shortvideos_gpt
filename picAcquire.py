...
def downloadPic(html, keyword, root, startNum, n,max_retry=10):
...
def download_pics(keyword, n, root):
    ...
    for i in range(pages):  # 修改 for 循环，循环 pages 次
        if count < n:  # 判断 count 是否小于 n
            ...
            lastNum, urls = downloadPic(html.text, keyword, root, lastNum,
...
if __name__=="__main__":
    address=get_pics(['big snake,scaring','猫咪'],['*1','1'],'E:\DeskTop\ds2')
    print(address)
